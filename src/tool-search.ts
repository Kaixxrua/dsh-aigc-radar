...
export function applyRadarTools(ctx: Context, apiBase: string, mcpToken: string, timeoutMs: number, maxPageSize: number): void {
  ...
  ctx.tools.register(defineTool({
    ...
    description:
      ...
      'Use it proactively: one check before implementing a major subsystem avoids rebuilding what already exists.',
    parameters: {
